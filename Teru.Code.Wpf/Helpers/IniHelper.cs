...
namespace Teru.Code.Wpf.Helpers
{
    public static class IniHelper
    {
        ...
        {
            string iniFilePath = inipath;
            int OpStation = WritePrivateProfileString(Section, Key, null, iniFilePath);
            bool flag3 = OpStation == 0L;
            return !flag3;
        }
        ...
        {
            string iniFilePath = inipath;
            int OpStation = WritePrivateProfileSection(Section, null, iniFilePath);
            bool flag3 = OpStation == 0L;
            return !flag3;
        }
